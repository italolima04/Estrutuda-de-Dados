// NOTE Em C++, a ocorrência de `const` após o nome de um método indica a
// promessa
...
class set {
 ...
 public:
  ...
  // NOTE Em C++, o "&" antes do nome da variável, neste caso, significa que
  // iremos receber
  //      o outro conjunto por referência. Você não precisa se preocupar com
  //      isso, pois a sintaxe dentro do método funcionará como antes.
